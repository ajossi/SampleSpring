...
<form action="#" id="bSaveForm" method="post">
...
<table colspan="1">
	<tbody>
		<tr>
			...
			<th><input type="text" class="txt" name="bTitle" id="bTitle" placeholder="제목을 입력하세요."/></th>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><textarea class="txt" name="bCon" id="bCon" rows="10" cols="20"></textarea></td>
		</tr>
	</tbody>
</table>
<input type="button" name="bSaveBtn" id="bSaveBtn" class="btn_Con" value="확인"/>
