...
<table colspan="1">
	<tbody>
		<tr>
			...
			<th><input type="text" class="txt" name="titleTxt" id="titleTxt" placeholder="제목을 입력하세요."/></th>
		</tr>
		<tr>
			<th class="table_attr">작성자</th>
			<th><input type="text" class="txt" name="nmTxt" id="nmTxt" readonly="readonly" value="${sBmNm}"/></th>
		</tr>
		<tr>
			<td colspan="2"><textarea class="txt" name="conTxt" id="conTxt" rows="10" cols="20"></textarea></td>
		</tr>
	</tbody>
</table>
<input type="button" name="saveBtn" id="saveBtn" class="btn_Con" value="확인"/>
