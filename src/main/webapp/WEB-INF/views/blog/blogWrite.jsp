...
<body>
	<form action="#" id="actionForm" method="post">
 		<input type=hidden id="blogNo" name="blogNo" value="${sBmNo}" />
		<div class="bar_wrap"></div>
		<div class="area">
		<div class="bar" id="loginBar" style="display: inline-block;">
			...
			<div class="area_b">
				<div class="gbn">새글쓰기</div>
				<table colspan="1">
					<tbody>
						<tr>
							<th class="table_attr">제목</th>
							<td><input type="text" class="txt_s" name="bTitle"
				...
				<div class="btn_area">
					<div class="btn" id="writeBtn" style="margin-right: 20px;">등록</div>
