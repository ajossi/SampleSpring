...
/* -------------------------------버튼영역--------------------------------------- */
		...
		$("#bmPwCheck").on("focusout", function() {
			if ($.trim($("#bmPwtxt").val()) != $.trim($("#bmPwCheck").val())) {
	...
	<div class="area">
		...
		<div class="area_a">
			...
			<form action="#" id="actionForm" method="post">
				...
				<div class="btn" id="joinBtn">가입</div>
